  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-lg mx-auto text-center">
        ...
        <h1 className="text-4xl font-minecraft mb-4 text-green-400">Sucesso!</h1>
        ...
        <div className="minecraft-panel mb-8">
          ...
          <div className="bg-minecraft-black bg-opacity-50 p-4 rounded mb-4">
            <h3 className="font-minecraft mb-2">Para acessar o servidor:</h3>
            <div className="text-yellow-300 font-minecraft mb-2">
              190.102.40.99:26040
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link to="/" className="minecraft-button">
            Voltar para a Página Inicial
          </Link>
          <Link to="/loja" className="minecraft-button bg-minecraft-grass">
            Continuar Comprando
          </Link>
        </div>
        ...
        <div className="mt-12 text-sm text-gray-400">
          ...
          <a href="mailto:suporte@jackmine.com" className="text-blue-400 underline">
